...
public class LeftSwitch2Cube extends CommandGroup {
    ...
    public LeftSwitch2Cube() {
        ...
        addSequential(new DriveStraightForCounts(8000, false));
        addSequential(new TurnToHeading(50));
