...
public class DriveStraightLimited extends Command {

    private int driveCounts;
    private boolean driveBackwards;
    private boolean driveWithGyro;

    public DriveStraightLimited(int counts, boolean backwards, boolean useGyro) {
    ...
    protected void execute() {
        if(Robot.driveSystem.getLeftEncoderPosition() <= driveCounts){
